...
## Dataset
The [dataset](https://www.kaggle.com/competitions/demand-forecasting-kernels-only/overview) was sourced from the "Demand Forecasting Kernels Only" competition on Kaggle.
